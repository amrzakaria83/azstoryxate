...
<section id="booking" class="articles">
    ...
    <form id="bookingForm">
      ...
      <textarea id="details" rows="4" placeholder="تفاصيل الجلسة..." required></textarea>
      <button type="submit">إرسال الحجز</button>
    </form>
    <p id="bookingMsg" style="margin-top:10px;color:green;font-weight:bold;"></p>
  </section>
  ...
  <div id="reviewsList">
    <div class="no-reviews">
      ...
      <p>لا توجد تقييمات حتى الآن. كن أول من يضع تقييماً!</p>
    </div>
  </div>
  ...
  <form id="reviewForm">
    ...
    <div class="form-group">
      ...
      <input type="text" id="reviewer" placeholder="اكتب اسمك..." required>
    </div>
    ...
    <div class="form-group">
      ...
      <textarea id="comment" rows="4" placeholder="شاركنا رأيك..." required></textarea>
    </div>
  ...
  <script>
    ...
    function updateStats() {
      ...
      fiveStarCountEl.textContent = fiveStars;
    }
    ...
    reviewForm.addEventListener('submit', function(e) {
      ...
      reviews.unshift(newReview); // إضافة في المقدمة
      ...
      // إضافة تأثير للتقييم الجديد
      setTimeout(() => {
        const firstReview = reviewsList.querySelector('.review-item');
        if (firstReview) {
          firstReview.classList.add('new-review');
        }
      }, 100);
    });
    ...
    reviews = [
      {
        name: 'أحمد محمد',
        rating: 5,
        comment: 'خدمة ممتازة وجودة عالية. أنصح بشدة!',
        date: '2024/08/15'
      },
      {
        name: 'فاطمة علي',
        rating: 4,
        comment: 'تجربة جيدة جداً، لكن يمكن تحسين سرعة التوصيل.',
        date: '2024/08/10'
      },
      {
        name: 'محمد صالح',
        rating: 5,
        comment: 'تعامل راقي واحترافية عالية. شكراً لكم.',
        date: '2024/08/05'
      }
    ];
   ...
   <div style="background: #667eea; color: white; padding: 20px; border-radius: 10px; text-align: center; margin: 20px 0;">
    ...
    <script>
        ...
        document.addEventListener('click', function(e) {
            ...
            if (!nav.contains(e.target) && mobileMenu.classList.contains('show')) {
                mobileMenu.classList.remove('show');
                menuToggle.classList.remove('active');
            }
        });
        ...
        // Apply animation to service and article cards
        document.addEventListener('DOMContentLoaded', function() {
            const cards = document.querySelectorAll('.service-card, .article-card, .video-card');
    ...
    bookingForm.addEventListener("submit", function(e){
      e.preventDefault();
      bookingMsg.textContent = "✅ تم إرسال الحجز بنجاح! سنتواصل معك قريباً.";
      bookingForm.reset();
    });
