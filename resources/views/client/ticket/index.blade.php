    ...
    <div data-kt-swapper="true" data-kt-swapper-mode="prepend" data-kt-swapper-parent="{default: '#kt_content_container', 'lg': '#kt_header_nav'}" class="page-title d-flex align-items-center flex-wrap me-3 mb-5 mb-lg-0">
        ...
        <ul class="breadcrumb breadcrumb-separatorless fw-bold fs-7 my-1">
            <li class="breadcrumb-item text-muted px-2">
                <a  href="#" class="text-muted text-hover-primary">البطاقات</a>
            </li>
                ...
                <div class="card-header border-0 pt-6">
                    <div class="card-title">
                        ...
                        <div class="d-flex align-items-center position-relative my-1">
                            ...
                            <input type="text" data-kt-db-table-filter="search" id="search" name="search" class="form-control form-control-solid bg-light-dark text-dark w-250px ps-14" placeholder="Search ticket" />
                        </div>
                    </div>
                    <div class="card-toolbar">
                        <!--begin::Toolbar-->
                        <div class="d-flex justify-content-end dbuttons">
                            <a href="{{route('client.tickets.create')}}" class="btn btn-sm btn-icon btn-primary btn-active-dark me-3 p-3">
                    ...
                    <table class="table align-middle table-rounded table-striped table-row-dashed fs-6" id="kt_datatable_table">
                        ...
                        <thead class="bg-light-dark pe-3">
                            ...
                            <tr class="text-start text-dark fw-bold fs-4 text-uppercase gs-0">
                                ...
                                <th class="min-w-125px text-start">اسم المشروع</th>
                                <th class="min-w-125px text-start">نوع الرد</th>
                        ...
                        <div class="modal-content">
                            ...
                            <div class="modal-body scroll-y mx-5 mx-xl-15 my-7">
                                <!--begin::Form-->
                                    ...
                                    <div class="d-flex flex-column scroll-y me-n7 pe-7" id="kt_modal_add_ticket_scroll" data-kt-scroll="true" data-kt-scroll-activate="{default: false, lg: true}" data-kt-scroll-max-height="auto" data-kt-scroll-dependencies="#kt_modal_add_ticket_header" data-kt-scroll-wrappers="#kt_modal_add_ticket_scroll" data-kt-scroll-offset="300px">

                                        <div class="fv-row mb-7">

                                            <label class="required fw-semibold fs-6 mb-2">مستخدم ؟</label>
                                            <select name="bdg" id="bdg" data-control="select2" data-placeholder="اختـر ..." data-hide-search="true" class="form-select form-select-solid fw-bold">
                                                <option></option>
            ...
            if (checkIDs.length > 0) {
                ...
                Swal.fire({
                    ...
                    if (isConfirm.value) {
                        $.ajax(
                        {
                            url: "{{route('client.tickets.delete')}}",
                            type: 'post',
                            dataType: "JSON",
                            data: {
                                "id": checkIDs,
