<!--begin::Header-->
<div id="kt_app_header" class="app-header d-flex flex-column flex-stack d-print-none">
    <!--begin::Header main-->
        ...
        <div class="app-navbar flex-grow-1 justify-content-end" id="kt_app_header_navbar">
            ...
            <div class="app-navbar-item ms-2 ms-lg-6" id="kt_header_user_menu_toggle">
                ...
                <div class="cursor-pointer symbol symbol-circle symbol-30px symbol-lg-45px" data-kt-menu-trigger="{default: 'click', lg: 'hover'}" data-kt-menu-attach="parent" data-kt-menu-placement="bottom-start">
                    @if (Auth::user()->getMedia('profile')->count())
                        <img src="{{Auth::user()->getFirstMediaUrl('profile')}}" alt="{{$settings->append_name}}" />
                    @else
                ...
                <div class="menu menu-sub menu-sub-dropdown menu-column menu-rounded menu-gray-800 menu-state-bg menu-state-color fw-semibold py-4 fs-6 w-275px" data-kt-menu="true">
                    ...
                    <div class="menu-item px-3">
                        <div class="menu-content d-flex align-items-center px-3">
                            ...
                            <div class="symbol symbol-50px me-5">
                                @if (Auth::user()->getMedia('profile')->count())
                                <img alt="{{$settings->append_name}}" src="{{Auth::user()->getFirstMediaUrl('profile')}}" />
                                @else
                                    <img alt="{{$settings->append_name}}" src="{{asset('dash/assets/media/avatars/blank.png')}}" />
                                @endif
                            </div>
                    ...
                    <div class="menu-item px-5">
                        <a href="{{route('client.users.show', Auth::id())}}" class="menu-link px-5">{{trans('auth.profile')}}</a>
                    </div>
                    ...
                    <div class="menu-item px-5">
                        <a href="{{route('client.logout')}}" class="menu-link px-5">{{trans('auth.logout')}}</a>
                    </div>
                    <!--end::Menu item-->
                </div>
            ...
            <div class="app-navbar-item ms-2 ms-lg-6 me-lg-5">
                <!--begin::Link-->
                <a href="{{route('client.logout')}}" class="btn btn-icon btn-custom btn-color-gray-600 btn-active-color-primary w-35px h-35px w-md-40px h-md-40px">
