                ...
                <div class="card-header border-0 pt-6">
                    ...
                    <div class="card-toolbar">
                        ...
                        <div class="d-flex justify-content-end dbuttons">
                            <a href="{{route('admin.contact_requests.create')}}" class="btn btn-sm btn-icon btn-primary btn-active-dark me-3 p-3">
                    ...
                    <table class="table align-middle table-rounded table-striped table-row-dashed fs-6" id="kt_datatable_table">
                        ...
                        <thead class="bg-light-dark pe-3">
                            ...
                            <tr class="text-center text-dark fw-bold fs-4 text-uppercase gs-0">
                                ...
                                <th class="min-w-125px text-center">{{trans('lang.age')}}</th>
                                <th class="min-w-125px text-center">{{trans('lang.qualification')}}</th>
                                <th class="min-w-125px text-center">{{trans('lang.job')}}</th>
                                <th class="min-w-125px text-center">{{trans('lang.marital_status')}}</th>
                                <th class="min-w-125px text-center">{{trans('lang.message')}}</th>
                                <th class="min-w-125px text-center">{{trans('lang.status')}}</th>
                                <th class="min-w-125px text-center">{{trans('lang.createdatreq')}}</th>
...
<script>
    $(function () {
        ...
        var table = $('#kt_datatable_table').DataTable({
            ...
            ajax: {
                url: "{{ route('admin.contact_requests.index') }}",
                data: function (d) {
